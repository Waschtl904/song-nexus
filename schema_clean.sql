-- ============================================================================
-- 📊 SONG-NEXUS: BEREINIGTES DATENBANKSCHEMA v1.1
-- ============================================================================
-- PostgreSQL database dump
-- Basis: Live-DB-Audit 13. Mai 2026
-- Änderungen gegenüber schema.sql (v1.0):
--   - magic_links Tabelle entfernt (veraltet, 0 Einträge)
...
--   - design_system: created_at + UNIQUE index auf is_active hinzugefügt
--   - play_history: Permissions zu song_nexus_user angeglichen
-- Aktive Tabellen: 9 (statt 10)
-- ============================================================================
...
-- ============================================================================
-- TABLE: magic_link_tokens (einzige aktive Magic-Link-Tabelle)
-- ============================================================================
...
-- ============================================================================
-- TABLE: tracks (price_eur und duration_seconds sind die einzigen echten Spalten)
-- ============================================================================
...
-- ============================================================================
-- TABLE: users (ohne webauthn_credential jsonb - nie verwendet)
-- ============================================================================
...
-- Sicherstellt: nur EINE aktive design_system-Zeile möglich
